			...
			if ($comp == 'comments') {
				...
				$output .= ($emotions_allowed
								...
								. '<span class="post_counters_label">'
									. ($emotions_allowed?(1==$post_likes ? esc_html__('Reaction', 'trx_addons') : esc_html__('Reactions', 'trx_addons')): (1==$post_likes ? esc_html__('Like', 'trx_addons') : esc_html__('Likes', 'trx_addons'))
										)
								. '</span>'
							. '</a> ';
			}
